...
df2 <- read.csv("mapped_reads/SLC25A4.fasta/quant.sf", sep="\t")
...
# Write to csv
write.csv(df,"plots/ENST_num_reads.txt",row.names=F)
write.csv(df,"plots/SLC25_num_reads.txt",row.names=F)
