...
SALMON_INDEX=/scratch/mjpete11/linear_models/batch1_simulations/gencode_index/
LIBTYPE=A
THREADS=8
...
do
		count=$(printf "%02d" $i)
		#count=$i
		fq1=/scratch/mjpete11/linear_models/batch1_simulations/1000_simulations/sample_${count}_1.fasta
		fq2=/scratch/mjpete11/linear_models/batch1_simulations/1000_simulations/sample_${count}_2.fasta
