...
sd(organs$log2_cpm) # 3.71
sd(organs$log2_cpm) * 6 # +/- 22.3 
...
violin <- function(GENE){
	     ...
	     p <- ggplot(dat, aes(x = organ, y = log2_cpm, fill = organ)) +
			  ...
			  stat_compare_means(method = "wilcox.test", 
	   		  ...
	   		  ggsave(paste0("/scratch/mjpete11/linear_models/linear/no_batch_correction_violins/no_batch_violin_plots/", GENE, ".png"), device="png")
}
