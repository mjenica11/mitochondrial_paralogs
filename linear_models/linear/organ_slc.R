...
A1 <- na.omit(A1)
model1 <- lm(value ~ 0 + organ, data=A1)
res1 <- summary(model1)
sink(paste("/scratch/mjpete11/linear_models/results4/","SLC1_organ.csv",sep=""))
print(res1)
sink()
...
res2 <- summary(model2)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC2_organ.csv",sep=""))
print(res2)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC2_check_model.pdf",sep=""))
m2
dev.off()
...
res3 <- summary(model3)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC3_organ.csv",sep=""))
print(res3)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC3_check_model.pdf",sep=""))
m3
dev.off()
...
res4 <- summary(model4)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC4_organ.csv",sep=""))
print(res4)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC4_check_model.pdf",sep=""))
m4
dev.off()
...
res5 <- summary(model5)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC5_organ.csv",sep=""))
print(res5)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC5_check_model.pdf",sep=""))
m5
dev.off()
...
res6 <- summary(model6)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC6_organ.csv",sep=""))
print(res6)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC6_check_model.pdf",sep=""))
m6
dev.off()
...
res7 <- summary(model7)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC10_organ.csv",sep=""))
print(res7)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC10_check_model.pdf",sep=""))
m7
dev.off()
...
res8 <- summary(model8)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC11_organ.csv",sep=""))
print(res8)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC11_check_model.pdf",sep=""))
m8
dev.off()
...
res9 <- summary(model9)
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC12_organ.csv",sep=""))
print(res9)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC12_check_model.pdf",sep=""))
m9
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC13_organ.csv",sep=""))
print(res10)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC13_check_model.pdf",sep=""))
m10
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC14_organ.csv",sep=""))
print(res11)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC14_check_model.pdf",sep=""))
m11
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC15_organ.csv",sep=""))
print(res12)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC15_check_model.pdf",sep=""))
m12
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC16_organ.csv",sep=""))
print(res13)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC16_check_model.pdf",sep=""))
m13
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC17_organ.csv",sep=""))
print(res14)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC17_check_model.pdf",sep=""))
m14
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC18_organ.csv",sep=""))
print(res15)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC18_check_model.pdf",sep=""))
m15
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC19_organ.csv",sep=""))
print(res16)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC19_check_model.pdf",sep=""))
m16
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC20_organ.csv",sep=""))
print(res17)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC20_check_model.pdf",sep=""))
m17
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC21_organ.csv",sep=""))
print(res18)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC21_check_model.pdf",sep=""))
m18
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC22_organ.csv",sep=""))
print(res19)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC22_check_model.pdf",sep=""))
m19
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC23_organ.csv",sep=""))
print(res20)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC23_check_model.pdf",sep=""))
m20
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC24_organ.csv",sep=""))
print(res21)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC24_check_model.pdf",sep=""))
m21
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC25_organ.csv",sep=""))
print(res22)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC25_check_model.pdf",sep=""))
m22
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC26_organ.csv",sep=""))
print(res23)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC26_check_model.pdf",sep=""))
m23
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC27_organ.csv",sep=""))
print(res24)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC27_check_model.pdf",sep=""))
m24
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC28_organ.csv",sep=""))
print(res25)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC28_check_model.pdf",sep=""))
m25
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC29_organ.csv",sep=""))
print(res26)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC29_check_model.pdf",sep=""))
m26
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC30_organ.csv",sep=""))
print(res27)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC30_check_model.pdf",sep=""))
m27
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC31_organ.csv",sep=""))
print(res28)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC31_check_model.pdf",sep=""))
m28
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC32_organ.csv",sep=""))
print(res29)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC32_check_model.pdf",sep=""))
m29
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC33_organ.csv",sep=""))
print(res30)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC33_check_model.pdf",sep=""))
m30
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC34_organ.csv",sep=""))
print(res31)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC34_check_model.pdf",sep=""))
m31
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC35_organ.csv",sep=""))
print(res32)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC35_check_model.pdf",sep=""))
m32
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC36_organ.csv",sep=""))
print(res33)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC36_check_model.pdf",sep=""))
m33
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC37_organ.csv",sep=""))
print(res34)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC37_check_model.pdf",sep=""))
m34
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC38_organ.csv",sep=""))
print(res35)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC38_check_model.pdf",sep=""))
m35
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC39_organ.csv",sep=""))
print(res36)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC39_check_model.pdf",sep=""))
m36
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC40_organ.csv",sep=""))
print(res37)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC40_check_model.pdf",sep=""))
m37
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC41_organ.csv",sep=""))
print(res38)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC41_check_model.pdf",sep=""))
m38
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC42_organ.csv",sep=""))
print(res42)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC42_check_model.pdf",sep=""))
m42
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC43_organ.csv",sep=""))
print(res43)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC43_check_model.pdf",sep=""))
m43
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC44_organ.csv",sep=""))
print(res44)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC44_check_model.pdf",sep=""))
m44
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC45_organ.csv",sep=""))
print(res45)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC45_check_model.pdf",sep=""))
m45
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC46_organ.csv",sep=""))
print(res46)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC46_check_model.pdf",sep=""))
m46
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC47_organ.csv",sep=""))
print(res47)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC47_check_model.pdf",sep=""))
m47
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC48_organ.csv",sep=""))
print(res48)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC48_check_model.pdf",sep=""))
m48
dev.off()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC49_check_model.pdf",sep=""))
m49
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC51_organ.csv",sep=""))
print(res49)
sink()
...
check_normality(model49)
check_collinearity(model49)
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC51_check_model.pdf",sep=""))
m49
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC52_organ.csv",sep=""))
print(res52)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC52_check_model.pdf",sep=""))
m52
dev.off()
...
sink(paste("/scratch/mjpete11/linear_models/results5/","SLC53_organ.csv",sep=""))
print(res53)
sink()
...
pdf(paste("/scratch/mjpete11/linear_models/results5/","SLC53_check_model.pdf",sep=""))
m53
dev.off()
