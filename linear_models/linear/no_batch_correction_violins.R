...
write.table(subset(striated, gene=="SLC25A47"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A52_no_batch.csv", sep=",", row.names=FALSE)
write.table(subset(striated, gene=="SLC25A2"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A52_no_batch.csv", sep=",", row.names=FALSE)
write.table(subset(striated, gene=="SLC25A48"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A52_no_batch.csv", sep=",", row.names=FALSE)
write.table(subset(striated, gene=="SLC25A21"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A52_no_batch.csv", sep=",", row.names=FALSE)
write.table(subset(striated, gene=="SLC25A41"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A52_no_batch.csv", sep=",", row.names=FALSE)
...
write.table(subset(not_striated, gene=="SLC25A42"), "/scratch/mjpete11/linear_models/data/sparsity_matrix_files/A41_no_batch.csv", sep=",", row.names=FALSE)
