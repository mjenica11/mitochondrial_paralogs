...
length(batch1_vect) # 148 
length(batch2_vect) # 148
...
violin <- function(GENE){
		...
		ggsave(paste0("/scratch/mjpete11/linear_models/batch_correction/simulated_voom_batch/plots_error_001/", GENE, ".png"), device="png")
}
