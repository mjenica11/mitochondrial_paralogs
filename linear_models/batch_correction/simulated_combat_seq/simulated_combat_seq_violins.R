...
# In batch #2 error rate = 0.001, ENSG00000164933 (SLC25A32) was filtered out

# Number of genes remaining
nrow(sub_df) # 53 

# Hugo-IDs without SLC25A32
#rm(SLC)
#SLC <- c("SLC25A1", "SLC25A2", "SLC25A3", "SLC25A4", "SLC25A5", "SLC25A6",
#		 "UCP1", "UCP2", "UCP3", "SLC25A10", "SLC25A11", "SLC25A12", 
#		 "SLC25A13", "SLC25A14", "SLC25A15", "SLC25A16", "SLC25A17", 
...
median(plotting_df$log2_cpm) # 5.77 
mean(plotting_df$log2_cpm) # 5.87
sd(plotting_df$log2_cpm) # 0.68
sd(plotting_df$log2_cpm) * 6 # +/- 5.05 
...
violin <- function(GENE){
	     ...
	     p <- ggplot(dat, aes(x = batch, y = log2_cpm, fill = batch)) +
				...
				ggtitle(paste0("Violin plot of combat-seq adjusted simulated ", GENE, " expression")) 
		ggsave(paste0("/scratch/mjpete11/linear_models/batch_correction/simulated_2SRI/simulated_combat_seq_violins/error_05_plots/", GENE, ".png"), device="png")
}
