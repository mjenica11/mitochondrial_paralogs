...
proj <- read.csv("/scratch/mjpete11/linear_models/results2/umap_unnormalized.csv", sep=",", header=TRUE)
...
ggsave(umap_plot(PROJ = proj3, FEATURE = "SMTSD"), file = "/scratch/mjpete11/linear_models/results2/tissue_umap.pdf")
                                   
# Color projections by tissue type 
ggsave(umap_plot(PROJ = proj3, FEATURE = "SMGEBTCH"), file = "/scratch/mjpete11/linear_models/results2/batch_umap.pdf")
